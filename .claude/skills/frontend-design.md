...
Write from the end user's side of the screen. Name things by what people control and recognize, never by how the system is built. Use active voice as default. Keep the register conversational and tuned: plain verbs, sentence case, no filler.
